...
server.onRequest = function(req, res) {
	...
	req.prerender._responseSent = new BehaviorSubject(false);
	Object.defineProperty(req.prerender, "responseSent", {
		get: function () {
	...
	req.prerender.o_responseSent = this._responseSent.asObservable();
	req.server = this;
